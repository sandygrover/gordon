...
function useDebouncedCallback(callback, delay, options) {
    ...
    var maxWaitHandler = react__default.useRef(null);
    var maxWaitArgs = react__default.useRef([]);
    var leading = options.leading;
    var wasLeadingCalled = react__default.useRef(false);
    var functionTimeoutHandler = react__default.useRef(null);
    var isComponentUnmounted = react__default.useRef(false);
    var debouncedFunction = callback;
    var cancelDebouncedCallback = react__default.useCallback(function () {
    ...
    var debouncedCallback = react__default.useCallback(function () {
        var args = [];
...
function useDebounce(value, delay, options) {
    var _a = react__default.useState(value), state = _a[0], dispatch = _a[1];
    var _b = callback.default(react__default.useCallback(function (value) { return dispatch(value); }, []), delay, options), callback$1 = _b[0], cancel = _b[1];
    var previousValue = react__default.useRef(value);
...
function useScrollDirection() {
  ...
  var lastScrollY = react.useRef(getScrollTop());
  ...
  var _useDebouncedCallback = lib_2(react.useCallback(function () {
