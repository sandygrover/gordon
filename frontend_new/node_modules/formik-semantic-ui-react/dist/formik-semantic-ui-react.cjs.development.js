...
var Form = function Form(props) {
  ...
  return React__default.createElement(semanticUiReact.Form, Object.assign({
...
var Field = function Field(_ref) {
  ...
  if (fast) {
    return React__default.createElement(formik.FastField, Object.assign({
      "data-testid": "fast-field"
    }, restProps), children);
  } else {
    return React__default.createElement(formik.Field, Object.assign({
      "data-testid": "field"
    }, restProps), children);
  }
};
...
var ResetButton = function ResetButton(_ref) {
  ...
  var formContext = formik.useFormikContext();
  return React__default.createElement(semanticUiReact.FormButton, Object.assign({
    id: RESET_BUTTON_ID,
    type: "button",
...
var SubmitButton = function SubmitButton(_ref) {
  ...
  var context = formik.useFormikContext();
  return React__default.createElement(semanticUiReact.FormButton, Object.assign({
    id: SUBMIT_BUTTON_ID,
    type: "submit",
...
var Input = function Input(_ref, ref) {
  ...
  var fieldLabel = label && React__default.createElement("label", {
    id: fieldLabelId,
    htmlFor: id
  }, label);
  ...
  var errorLabel = function errorLabel(meta) {
    ...
    return React__default.createElement(semanticUiReact.Label, Object.assign({
  ...
  return React__default.createElement(Field, {
    ...
    var _ref2$field = _ref2.field,
        ...
        meta = _ref2.meta;
    return React__default.createElement(semanticUiReact.FormField, {
      error: meta.touched && !!meta.error
    }, fieldLabel, errorLabelBefore(meta), React__default.createElement(semanticUiReact.Input, Object.assign({
      id: id,
      ref: ref,
      name: name,
      value: value,
      label: formik.isString(inputLabel) && {
        children: inputLabel,
        htmlFor: id,
        id: inputLabelId
      } || formik.isObject(inputLabel) && _extends({}, inputLabel, {
        htmlFor: id,
        id: inputLabelId
      }),
...
var TextArea = function TextArea(_ref, ref) {
  ...
  return React__default.createElement(Field, {
    ...
    var _ref2$field = _ref2.field,
        ...
        meta = _ref2.meta;
    return React__default.createElement(semanticUiReact.FormField, Object.assign({
      control: semanticUiReact.TextArea,
      ref: ref,
      name: name,
      value: value,
      onChange: function onChange(event, data) {
...
var Checkbox = function Checkbox(_ref) {
  ...
  return React__default.createElement(Field, {
    ...
    var _ref2$field = _ref2.field,
        ...
        meta = _ref2.meta;
    return React__default.createElement(semanticUiReact.FormField, Object.assign({
      control: semanticUiReact.Checkbox,
      name: name,
      checked: value,
      onChange: function onChange(event, data) {
...
var Select = function Select(_ref) {
  ...
  return React__default.createElement(Field, {
    ...
    var value = _ref2.field.value,
        ...
        meta = _ref2.meta;
    return React__default.createElement(semanticUiReact.FormField, Object.assign({
      control: semanticUiReact.Select,
      name: name,
      options: options,
      value: value,
      onChange: function onChange(event, data) {
...
var FormikDebug = function FormikDebug(props) {
  return  React__default.createElement("pre", {
    ...
    "data-testid": "debug"
  }, React__default.createElement(formik.Field, null, function (_ref) {
    var form = _ref.form;
...
//# sourceMappingURL=formik-semantic-ui-react.cjs.development.js.map
