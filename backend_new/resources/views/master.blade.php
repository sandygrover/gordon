...
<body>
        ...
        <div class="header">
			<div class="header-left">
				<a href="{{ route('home') }}" class="logo">
					<img src="{{ url('assets/img/logo.png') }}" width="150" height="35" alt="">
                    {{-- <span>PlayStock</span> --}}
				</a>
			</div>
                ...
                <div id="sidebar-menu" class="sidebar-menu">
                    <ul>
                        ...
                        <li class="{{ Request::is('users', 'adduser') ? 'active' : '' }}">
                            <a href="{{ route('users') }}"><i class="fa fa-wheelchair"></i> <span>User</span></a>
                        </li>
                        <li class="{{ Request::is('contests', 'contests/*') ? 'active' : '' }}">
                            <a href="{{ URL::to('contests') }}"><i class="fa fa-wheelchair"></i> <span>Contest</span></a>
                        </li>
                        <li class="{{ Request::is('contestCategory' , 'contestCategory/*') ? 'active' : '' }}">
                            <a href="{{ URL::to('contestCategory') }}"><i class="fa fa-wheelchair"></i> <span>Contest Category</span></a>
                        </li>
                        {{-- <li>
    ...
    <div class="sidecbar-overlay" data-reff=""></div>
    <script src="{{ url('assets/js/jquery-3.2.1.min.js') }}"></script>
	<script src="{{ url('assets/js/popper.min.js') }}"></script>
    <script src="{{ url('assets/js/bootstrap.min.js') }}"></script>
    <script src="{{ url('assets/js/jquery.slimscroll.js') }}"></script>
    <script src="{{ url('assets/js/Chart.bundle.js') }}"></script>
    ...
    <script>
        function deleteUser(id) {
            $("#deleteUserButton").attr("deleteid",id);
            $('#delete_user').modal('show');
        }

        function deleteUserButton() {
            let deleteid =$("#deleteUserButton").attr("deleteid");
            $.ajax({
        ...
        $(document).ready(function () {
            ...
            let status3 = currentUrl.includes('home');
            if(status3 == true) {
                var user = <?php echo $userArr ?? 'test'; ?>;
                var output = Object.values(user).map(n => n.toString())
                var lineChartData = {
                ...
                if (willDelete) {
                    ...
                    $.ajax({
                        ...
                        success: function(response) {
                            swal({
                                title: "Success",
                                text: "Your Selected Item Deleted Successfully",
                                type: "success"
                            }).then((ok) => {
                                location.reload();
                            });
